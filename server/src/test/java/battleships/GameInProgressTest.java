...
////        WaitForSalvos gameInProgress = new WaitForSalvos(handlerWrappersMocks, mockedFleet);
////        //when
...
////        WaitForSalvos gameInProgress = new WaitForSalvos(Arrays.asList(otherTestWrapper, secondTestWrapper), testFleet);
////        gameInProgress.process();
